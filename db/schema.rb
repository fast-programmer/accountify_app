...
ActiveRecord::Schema[7.1].define(version: 2024_11_16_070360) do
  ...
  create_table "outboxer_messages", force: :cascade do |t|
    ...
    t.index ["status", "updated_by_publisher_id", "updated_at"], name: "idx_outboxer_status_pub_id_updated_at"
    t.index ["status"], name: "idx_outboxer_status"
    t.index ["updated_by_publisher_id", "updated_at"], name: "idx_outboxer_pub_id_updated_at"
  end
