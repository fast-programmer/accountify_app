    ...
    describe '.create' do
      it 'creates model' do
        id, _event_id = Invoice.create(
          ...
          due_date: due_date, sub_total_amount: sub_total_amount)
      ...
      it 'creates created event' do
        id, event_id = Invoice.create(
          ...
          contact_id: contact.id, status: status, currency_code: currency_code,
          due_date: due_date, sub_total_amount: sub_total_amount)
        ...
        expect(event.body).to eq({
          'invoice' => {
            ...
            'sub_total_amount' => sub_total_amount.to_s } })
      end
